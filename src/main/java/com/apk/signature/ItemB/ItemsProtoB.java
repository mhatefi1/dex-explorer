...
public class ItemsProtoB extends ItemB {
    ...
    public byte[] getDataAsByte(HashMap<String, byte[]> header, ByteArrayInputStream stream, long start) {
        ...
        return appUtil.getByteByIndex(header, stream, return_type_idx, new ItemsTypeB());
    }
    ...
    public String getDataAsHex(HashMap<String, byte[]> header, ByteArrayInputStream stream, long start) {
        ...
        long return_type_idx = util.getDecimalValue(return_type_idx_b);
        long parameters_off = util.getDecimalValue(parameters_off_b);
        return appUtil.getHexByIndex(header, stream, return_type_idx, new ItemsTypeB());
    }

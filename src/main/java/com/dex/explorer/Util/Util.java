...
public class Util extends FileUtil {
    ...
    public static long getDecimalValue(byte[] bytes) {
    ...
    public static byte[] getBytesOfFile(byte[] stream, long offset, long size) {
        int to = (int) (offset + size);
        return Arrays.copyOfRange(stream, (int) offset, to);
    }

    public static String byteToStringHex(byte[] byteArray) {
    ...
    public static long stringHexToDecimal(String hex) {
        return Long.parseLong(hex, 16);
    }

    public static String decimalToStringHex(long value) {
    ...
    public static String[] splitTwoByTwo(String text) {
        int splitUnit = 2;
